...
.login-social-btn { text-decoration: none; }
    ...
    <div class="login-right">
      <div class="login-form-wrap">
          ...
          <div class="login-field">
            ...
            <div class="login-input-wrap">
              ...
              <input 
                ...
                required
              >
              <button type="button" class="login-eye-btn" id="togglePassword" aria-label="Tampilkan password">
        ...
        <div class="login-form-footer">
          <p>Dengan masuk, Anda menyetujui <a href="/terms" class="login-link">Syarat & Ketentuan</a> dan <a href="/privacy" class="login-link">Kebijakan Privasi</a> kami.</p>
        </div>
...
(function(){
    ...
    loginForm.addEventListener('submit', function(e){
      ...
      .then(function(result){
        if(result.data.success){
          ...
          showLoginError(result.data.message || 'Email atau password salah.');
        }
      })
      .catch(function(){
  ...
  function showLoginSuccess(){
    var container = document.querySelector('.login-form-wrap');
    var existing = container.querySelector('.login-alert-success');
    if(existing) return;

    var div = document.createElement('div');
    div.className = 'login-alert login-alert-success';
    div.innerHTML = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg><span>Login berhasil! Mengalihkan...</span>';
    container.insertBefore(div, container.querySelector('.login-form') || container.firstChild);

    // Sembunyikan tombol
    var btn = container.querySelector('.login-submit-btn');
    if(btn) btn.style.display = 'none';
  }

  function showLoginError(message){
    var container = document.querySelector('.login-form-wrap');
    var existing = container.querySelector('.login-alert-error');
    if(existing) existing.remove();

    var div = document.createElement('div');
    div.className = 'login-alert login-alert-error';
    div.innerHTML = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg><span>' + message + '</span>';
    container.insertBefore(div, container.querySelector('.login-form') || container.firstChild);
  }
})();
</script>
