        ...
        <div class="hero-track" id="heroTrack">
            <div class="hero-slide is-active">
                <div class="hero-bg">
                    ...
                    <div class="hero-bg-right">
                        <img src="https://images.unsplash.com/photo-1549298916-b41d501d3772?w=900&q=80&auto=format&fit=crop"
                            alt="CHRISBALE Footwear">
                    </div>
                </div>
            ...
            <div class="hero-slide">
                <div class="hero-bg-full">
                    <img src="https://images.unsplash.com/photo-1539185441755-769473a23570?w=1400&q=80&auto=format&fit=crop"
                        alt="Limited Edition">
                </div>
                <div class="hero-overlay">
                    ...
                    <p>Kulit Italia full-grain, insole memory foam, dan emblem emas khas kami. Eksklusif hanya di CHRISBALE
                        — sebelum habis.</p>
                    <div class="hero-actions">
                        <a href="#sale" class="btn-primary">Beli Koleksi <svg width="13" height="13"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                <path d="M5 12h14M13 6l6 6-6 6" />
                            </svg></a>
            ...
            <div class="hero-slide">
                <div class="hero-bg-full">
                    <img src="https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=1400&q=80&auto=format&fit=crop"
                        alt="New Arrivals">
                </div>
                <div class="hero-overlay">
                    ...
                    <div class="hero-actions">
                        <a href="#new" class="btn-primary">Lihat Barang Baru <svg width="13" height="13"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                <path d="M5 12h14M13 6l6 6-6 6" />
                            </svg></a>
                        <a href="#shop" class="btn-outline-hero">Jelajahi Semua</a>
            ...
            <div class="grid-prod">
                <article class="prod-card" onclick="window.location='/product/chrisbale-urban-runner'">
                    ...
                    <div class="prod-img-wrap">
                        <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&q=80&auto=format&fit=crop"
                            alt="CHRISBALE Urban Runner" loading="lazy">
                ...
                <article class="prod-card" onclick="window.location='/product/gold-leather-loafer'">
                    ...
                    <div class="prod-img-wrap">
                        <img src="https://images.unsplash.com/photo-1614252369475-531eba835eb1?w=600&q=80&auto=format&fit=crop"
                            alt="Gold Leather Loafer" loading="lazy">
                        <div class="prod-overlay"><button class="add-btn" onclick="event.stopPropagation()">+
                                Keranjang</button></div>
                    </div>
                    <div class="prod-info">
                ...
                <article class="prod-card" onclick="window.location='/product/combat-boot-black'">
                    <span class="badge-tag badge-new">Baru</span>
                    <div class="prod-img-wrap">
                        <img src="https://images.unsplash.com/photo-1608256246200-53e635b5b65f?w=600&q=80&auto=format&fit=crop"
                            alt="Combat Boot Black" loading="lazy">
                        <div class="prod-overlay"><button class="add-btn" onclick="event.stopPropagation()">+
                                Keranjang</button></div>
                    </div>
                    <div class="prod-info">
                ...
                <article class="prod-card" onclick="window.location='/product/classic-slip-on-white'">
                    ...
                    <div class="prod-img-wrap">
                        <img src="https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?w=600&q=80&auto=format&fit=crop"
                            alt="Classic Slip-On White" loading="lazy">
                        <div class="prod-overlay"><button class="add-btn" onclick="event.stopPropagation()">+
                                Keranjang</button></div>
                    </div>
                    <div class="prod-info">
        ...
        <div class="wrap">
            ...
            <div class="grid-prod">
                <article class="prod-card" onclick="window.location='/product/red-strap-sandal'">
                    <span class="badge-tag badge-new">Baru</span>
                    <div class="prod-img-wrap">
                        <img src="https://images.unsplash.com/photo-1603487742131-4160ec999306?w=600&q=80&auto=format&fit=crop"
                            alt="Red Strap Sandal" loading="lazy">
                        <div class="prod-overlay"><button class="add-btn" onclick="event.stopPropagation()">+
                                Keranjang</button></div>
                    </div>
                    <div class="prod-info">
                ...
                <article class="prod-card" onclick="window.location='/product/navy-slide-sandal'">
                    <span class="badge-tag badge-new">Baru</span>
                    <div class="prod-img-wrap">
                        <img src="https://images.unsplash.com/photo-1562183241-b937e9102f3b?w=600&q=80&auto=format&fit=crop"
                            alt="Navy Slide Sandal" loading="lazy">
                        <div class="prod-overlay"><button class="add-btn" onclick="event.stopPropagation()">+
                                Keranjang</button></div>
                    </div>
                    <div class="prod-info">
                ...
                <article class="prod-card" onclick="window.location='/product/brown-leather-mule'">
                    <div class="prod-img-wrap">
                        <img src="https://images.unsplash.com/photo-1516478177764-9fe5bd7e9717?w=600&q=80&auto=format&fit=crop"
                            alt="Brown Leather Mule" loading="lazy">
                        <div class="prod-overlay"><button class="add-btn" onclick="event.stopPropagation()">+
                                Keranjang</button></div>
                    </div>
                    <div class="prod-info">
        ...
        <div class="wrap">
            <div class="featured-banner">
                <div class="featured-img-side">
                    <img src="https://images.unsplash.com/photo-1539185441755-769473a23570?w=900&q=80&auto=format&fit=crop"
            ...
            <div class="featured-strip">
                <div class="strip-item">
                    <div class="strip-item-img"><img
                            src="https://images.unsplash.com/photo-1584735175315-9d5df23be1f2?w=500&q=80&auto=format&fit=crop"
                            alt="Gold Edition" loading="lazy"></div>
                    <div class="strip-item-info">
                        <h4>Gold Edition</h4><span>Rp4.489.000</span>
                    </div>
                </div>
                <div class="strip-item">
                    <div class="strip-item-img"><img
                            src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?w=500&q=80&auto=format&fit=crop"
                            alt="Midnight Black" loading="lazy"></div>
                    <div class="strip-item-info">
                        <h4>Midnight Black</h4><span>Rp3.889.000</span>
                    </div>
                </div>
                <div class="strip-item">
                    <div class="strip-item-img"><img
                            src="https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=500&q=80&auto=format&fit=crop"
                            alt="Cream Canvas" loading="lazy"></div>
                    <div class="strip-item-info">
                        <h4>Cream Canvas</h4><span>Rp2.089.000</span>
                    </div>
                </div>
                <div class="strip-item">
                    <div class="strip-item-img"><img
                    ...
                    <div class="strip-item-info">
                        <h4>Tan Chelsea</h4><span>Rp2.839.000</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="wrap">
            ...
            <div class="testi-scroll">
                <div class="testi-card">
                    ...
                    <blockquote>"Kualitasnya tak tertandingi. Saya sudah lama mencari sneaker premium yang benar-benar awet
                        — CHRISBALE jawabannya."</blockquote>
                ...
                <div class="testi-card">
                    ...
                    <blockquote>"Saya beli Gold Leather Loafers untuk pernikahan saya. Kriya yang sangat memukau. Sangat
                        direkomendasikan!"</blockquote>
                ...
                <div class="testi-card">
                    ...
                    <blockquote>"Pengiriman cepat dan Combat Boots-nya sangat nyaman langsung dari kotak. Tidak perlu masa
                ...
                <div class="testi-card">
                    ...
                    <blockquote>"Akhirnya merek sneaker yang terlihat premium tanpa harga yang berlebihan. Jadi andalan
                        sehari-hari saya."</blockquote>
